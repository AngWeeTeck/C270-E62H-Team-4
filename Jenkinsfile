pipeline {
    ...
    stages {
        ...
        stage('Security Scans') {
            environment {
                // Tells the Docker CLI to bypass the socket and use the Windows host TCP daemon
...
stage('Build Docker Image') {
    ...
    always {
        ...
        cleanup {
            script {
                echo "Fixing workspace permissions before cleanup..."
                // This resets permissions for both the main workspace and the container @2 workspace
