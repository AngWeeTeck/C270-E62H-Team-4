  ...
  const voteOnTarget = async (targetType, targetId, value) => {
    try {
      ...
      if (targetType === 'thread') {
        ...
        if (typeof window !== 'undefined' && window.__communityHub?.announceActivity) {
          window.__communityHub.announceActivity('vote-changed', {
    ...
    <div className="vote-actions">
      <button
        ...
        onClick={() => {
          ...
          voteOnTarget(targetType, targetId, 1);
        }}
      >
        ▲
      </button>
